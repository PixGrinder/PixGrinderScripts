...
buttonText:"Organise Layers"
icon:#("Felipe Scripts",9)
silentErrors:true
...
(
	...
	(
		...
		layermanager.newLayerFromName "cameras"
		layermanager.newLayerFromName "lights"
		layermanager.newLayerFromName "yy_collisions_yy"
		layermanager.newLayerFromName "items"
		layermanager.newLayerFromName "doors"
		layermanager.newLayerFromName "traps"
		layermanager.newLayerFromName "structure"
