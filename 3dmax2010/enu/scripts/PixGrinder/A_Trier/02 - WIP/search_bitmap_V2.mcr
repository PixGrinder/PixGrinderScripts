...
(
	...
	(
			...
			(
				...
				(
					pda_x = pda[i].ambientMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].specularMap != undefined do 
				(
					pda_x = pda[i].specularMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].specularLevelMap != undefined do 
				(
					pda_x = pda[i].specularLevelMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
				...
				(
					pda_x = pda[i].selfIllumMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].opacityMap != undefined do 
				(
					pda_x = pda[i].opacityMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].filterMap != undefined do 
				(
					pda_x = pda[i].filterMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].bumpMap != undefined do 
				(
					pda_x = pda[i].bumpMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].reflectionMap != undefined do 
				(
					pda_x = pda[i].reflectionMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].refractionMap != undefined do 
				(
					pda_x = pda[i].refractionMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
					
				if pda[i].displacementMap != undefined do 
				(
					pda_x = pda[i].displacementMap.bitmap as string
					if findstring pda_x filename != undefined do appendifunique pdaname pda[i]
				)
