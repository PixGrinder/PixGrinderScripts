macroScript SimplifyLine category:"- Gueshni -" Icon:#("g9_simplifyline", 1) tooltip:"Simplify Line"
 (
	rollout SimplifyLine "SimplifyLine"
(
-- VARIABLES
...
-- IHM
	...
	spinner distMax "Decalage Max d'un point" range:[0.0,100.0,0.2] type:#float
...
SimplifyLineFloater = newrolloutfloater "Simplify Line" 300 100 5 80
addrollout SimplifyLine SimplifyLineFloater
)