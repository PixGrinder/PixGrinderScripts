	...
	(
		...
		(
			...
			(
				...
				global p1 = $.center
				destroyDialog msg
				try fileIn "C:\Program Files\Autodesk\3ds Max 2010\ui\macroscripts\Felipe_Duplicator_exec.ms" catch()
				try fileIn "C:\Program Files\Autodesk\3ds Max 2013\macroscripts\Felipe_Duplicator_exec.ms" catch()
			)
